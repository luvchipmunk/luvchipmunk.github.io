...
![img](/images/2025-03-22-3-Python-Dictionary/img1.png)

1. 요소 삭제 - 삭제의 경우는 Key값만 입력하면 되는 듯 하다.

양식은 // del 변수명[Key] //

![img](/images/2025-03-22-3-Python-Dictionary/img2.png)
...
![img](/images/2025-03-22-3-Python-Dictionary/img3.png)

![img](/images/2025-03-22-3-Python-Dictionary/img4.png)

![img](/images/2025-03-22-3-Python-Dictionary/img5.png)

2. Key 리스트 불러오기 - 변수명.keys()

위 dic변수로한 예시에서,![img](/images/2025-03-22-3-Python-Dictionary/img6.png)dict_keys([key명]) **객체** 형태로 결과를 내놓는다.![img](/images/2025-03-22-3-Python-Dictionary/img7-1774205047426-12.png)

-> 이를 리스트 형태로 변환하려면,

list(변수명.keys()) 형태로 불러내야한다.![img](/images/2025-03-22-3-Python-Dictionary/img8.png)

\* 애초에 리스트 형태로 불러오던때가 있었는데, 리스트 자체가 메모리 낭비성을 띄고 있는듯 하다. 때문에, 현 버전에서는 객체형태로 돌려주는 듯 하다.

**<<주의사항>>

- Key가 중복으로 등록되면, 기존 앞의 쌍이 무시된다.![img](/images/2025-03-22-3-Python-Dictionary/img9.png)
- 위에서 이야기했듯, Key에 리스트는 쓸 수 없다. but, 튜플은 가능하다. 리스트는 값이 변할 수 있기 때문에 Key로 쓸 수 없는 것이다.![img](/images/2025-03-22-3-Python-Dictionary/img10.png)

3. value 리스트 만들기도 가능한데,

변수명.values() << 형태로 가능하다.

![img](/images/2025-03-22-3-Python-Dictionary/img11.png)

4. Key, Value 쌍으로 다 얻기 - 변수명.items()![img](/images/2025-03-22-3-Python-Dictionary/img12.png)
...
존재하지 않는 key를 get 형태로 불러오려고 하면, None을 돌려준다는 차이가 존재한다.![img](/images/2025-03-22-3-Python-Dictionary/img13.png)
...
![img](/images/2025-03-22-3-Python-Dictionary/img14.png)
...
![img](/images/2025-03-22-3-Python-Dictionary/img15.png)
